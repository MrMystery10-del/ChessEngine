...
public class PlayersGUI extends Screen {
    ...
    public PlayersGUI(Player player1, Player player2) {
        ...
        label1.setBounds(640, 540, 800, 200);
        label1.setFont(font);
        add(label1);
    ...
    protected void paintComponent(Graphics g) {
        ...
        g2d.drawImage(player2.getImage(), 0, 0, (int) (getWidth() / 3.55), imageSize, null);
        g2d.drawImage(player1.getImage(), 0, imageSize, (int) (getWidth() / 3.55), imageSize, null);
