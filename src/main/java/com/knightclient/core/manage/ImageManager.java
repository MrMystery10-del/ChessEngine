package com.knightclient.core.manage;
...
public class ImageManager {
    ...
    private final static Map<manage.Pieces, BufferedImage> pieceImages = new HashMap<>();
    ...
    public static void loadImages() throws IOException {
        ...
        pieceImages.put(manage.Pieces.PAWN, loadImage("/images/pieces/pawn.png"));
        pieceImages.put(manage.Pieces.BISHOP, loadImage("/images/pieces/bishop.png"));
        pieceImages.put(manage.Pieces.KNIGHT, loadImage("/images/pieces/knight.png"));
        pieceImages.put(manage.Pieces.ROOK, loadImage("/images/pieces/rook.png"));
        pieceImages.put(manage.Pieces.QUEEN, loadImage("/images/pieces/queen.png"));
        pieceImages.put(manage.Pieces.KING, loadImage("/images/pieces/king.png"));
        pieceImages.put(manage.Pieces.PAWN_BLACK, loadImage("/images/pieces/pawn_BLACK.png"));
        pieceImages.put(manage.Pieces.BISHOP_BLACK, loadImage("/images/pieces/bishop_BLACK.png"));
        pieceImages.put(manage.Pieces.KNIGHT_BLACK, loadImage("/images/pieces/knight_BLACK.png"));
        pieceImages.put(manage.Pieces.ROOK_BLACK, loadImage("/images/pieces/rook_BLACK.png"));
        pieceImages.put(manage.Pieces.QUEEN_BLACK, loadImage("/images/pieces/queen_BLACK.png"));
        pieceImages.put(manage.Pieces.KING_BLACK, loadImage("/images/pieces/king_BLACK.png"));
     ...
     */
    public static BufferedImage getPiece(manage.Pieces piece) {
